...
// add_action( 'gform_after_submission_', 'set_post_content', 10, 2 );
// function send_gravity_form_data(){
//     $body = [];
...
//         }
//         if(isset($entry['31'])){
//             $body['full_name'] = $entry['31'];
//         }
//         if(isset($entry['22'])){
//             $body['company_name'] = $entry['22'];
//         }
//         if(isset($entry['33'])){
//             $body['country'] = $entry['33'];
//         }
//         if(isset($entry['5'])){
//             $body['phone'] = $entry['5'];
//         }
//         if(isset($entry['41'])){
//             $body['website'] = $entry['41'];
//        }
